...
import com.rts.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "rts");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.rts");
